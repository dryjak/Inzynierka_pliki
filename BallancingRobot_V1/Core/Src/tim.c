...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(EncoderB_SigA_GPIO_Port, EncoderB_SigA_Pin);

    HAL_GPIO_DeInit(EncoderB_SigB_GPIO_Port, EncoderB_SigB_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, EncoderA_SigA_Pin|EncoderA_SigB_Pin);
