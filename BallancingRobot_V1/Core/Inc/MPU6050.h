...
//depends on your interrupt frequency
//it is used to calculate angle from gyro
#define DT					0.01

//Offset based on your callibration (there is function to calibrate your MPU6050
#define ACCEL_OFFSET_X		428.880005
#define ACCEL_OFFSET_Y		-358.980011
#define ACCEL_OFFSET_Z		-7258.09961

#define GYRO_OFFSET_X		-123.58996
#define GYRO_OFFSET_Y		135.934998
#define GYRO_OFFSET_Z		-61.6300011
